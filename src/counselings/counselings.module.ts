...
@Module({
  imports: [
    TypeOrmModule.forFeature([Counseling, Schedule, User, ExpertProfile]),
    forwardRef(() => ChatModule),
  ],
  providers: [CounselingsService, RabbitMQService, CounselingConsumer, RedisService],
  controllers: [CounselingsController],
